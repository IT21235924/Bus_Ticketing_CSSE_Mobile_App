...
class CurrentoffersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        createButton.setOnClickListener {
            startActivity(Intent(this, CreateoffersActivity::class.java))
        }
        ...
        db.collection("offers")
            ...
            .addOnSuccessListener { documents ->
                ...
                val comps = documents.map { it.toObject(offers::class.java) }
                ...
                complistview.onItemClickListener =
                    AdapterView.OnItemClickListener { parent, view, position, id ->
                        ...
                        val intent = Intent(this, EditoffersActivity::class.java)
